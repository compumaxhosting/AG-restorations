        ...
        {navItems.map(({ label, path, subItems }) => {
          ...
          return subItems ? (
            ...
            >
              ...
              <div
                className={`absolute left-0 top-full mt-1 bg-white border-t-4 border-[#e63a27] shadow-lg rounded-sm z-50 min-w-45 overflow-hidden transition-all duration-300 ease-in-out ${
                  openDropdown === label
