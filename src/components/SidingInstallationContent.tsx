      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-stretch mb-12">
          ...
          <div className="w-full h-full">
            <div className="relative w-full h-full min-h-100 overflow-hidden rounded-lg ">
              <Image
                src="/Professional-Siding-Installation-in-Linden,-NJ.webp"
                alt="Professional Siding Installation in Linden, NJ"
                fill
          ...
          <div className="flex flex-col justify-center">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold text-[#1b2a41] leading-tight mb-6">
              Professional Siding Installation in Linden, NJ: Refresh & Protect
              Your Home
            </h1>

            {/* Intro */}
            <p className="text-gray-600 leading-relaxed mb-4">
              Your home’s siding does more than just look good—it’s the first
              line of defense against New Jersey’s shifting seasons. Whether you
              are looking to lower your utility bills with energy-efficient
              siding installation in Linden, NJ, or your current exterior has
              seen better days, finding the right siding contractors in Linden,
              NJ is the most important step in the process.
            </p>
        ...
        <div className="max-w-4xl mx-auto">
          <p className="text-gray-600 leading-relaxed mb-8">
            We know that every house has its own character, which is why we
            offer everything from classic vinyl siding installation to durable
            options from a specialized fiber cement siding contractor. As a
            local Linden, NJ siding company, we focus on delivering a look
            you’ll love with the structural integrity your home deserves.
          </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 text-gray-700">
                ...
                <p>
                  ...
                  Fully insured professionals who know local Union County
                  building codes.
                </p>
              </div>
              ...
              <div className="flex items-start gap-3 text-gray-700">
                <FiCheck className="text-red-500 mt-1" />
                <p>
                  <strong>Versatile Material Options:</strong> Expertise in
                  vinyl, fiber cement, and wood-look composites.
                </p>
              </div>
          ...
          <div className="mb-10">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              repairs, ensuring long-lasting protection and enhanced curb
              appeal. Trust our licensed local team for high-quality, affordable
              siding solutions today.
            </p>
          </div>
          ...
          <div className="mb-10">
            ...
            <div className="space-y-5 text-gray-600">
              ...
              <p>
                ...
                <br />
                Yes! We provide full siding repair services, from storm damage
                to loose panels.
              </p>
            </div>
          </div>
