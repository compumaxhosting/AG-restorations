        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          {items.map((item, i) => (
            ...
            >
              ...
              {/* orange half background */}
              <div className="absolute top-0 left-0 w-full h-1/2 bg-orange-600 transition-all duration-500 group-hover:h-full"></div>
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                {/* button */}
                <button className="mt-4 text-white text-sm font-semibold opacity-0 group-hover:opacity-100 transition">
                  › LEARN MORE
                </button>
