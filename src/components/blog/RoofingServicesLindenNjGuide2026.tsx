            ...
            <div className="space-y-3">
              <div className="rounded-xl border border-slate-200 p-4">
                <h3 className="font-semibold text-[#1b2a41]">
                  How often should I schedule a roof inspection in Linden NJ?
                </h3>
                <p className="mt-2 text-slate-700">
                  Most roofing professionals recommend an inspection at least once per year and after major storms. Regular inspections can identify small issues before they develop into larger, more expensive problems.
                </p>
              </div>
              ...
              <div className="rounded-xl border border-slate-200 p-4">
                ...
                <p className="mt-2 text-slate-700">
                  A professional inspection can determine whether repairs are sufficient or if replacement is more practical. Factors include roof age, extent of damage, recurring leaks, and overall condition.
                </p>
              </div>
              ...
              <div className="rounded-xl border border-slate-200 p-4">
                ...
                <p className="mt-2 text-slate-700">
                  Move valuables away from the affected area, contain water if possible, and contact a roofing contractor promptly. Delaying repairs can increase damage to interior building components.
                </p>
              </div>

              <div className="rounded-xl border border-slate-200 p-4">
                <h3 className="font-semibold text-[#1b2a41]">
                  Is emergency roof repair available after storms?
                </h3>
                <p className="mt-2 text-slate-700">
                  Many roofing contractors provide emergency roof repair services to help minimize water intrusion and stabilize damaged roofing systems until permanent repairs can be completed.
                </p>
              </div>

              <div className="rounded-xl border border-slate-200 p-4">
                <h3 className="font-semibold text-[#1b2a41]">
                  What is the most common roofing material for homes in New Jersey?
                </h3>
                <p className="mt-2 text-slate-700">
                  Asphalt shingles are among the most widely used residential roofing materials due to their affordability, durability, and suitability for local weather conditions.
                </p>
              </div>
              ...
              <div className="rounded-xl border border-slate-200 p-4">
                ...
                <p className="mt-2 text-slate-700">
                  Roof lifespan depends on material type, installation quality, maintenance, weather exposure, and environmental conditions. Regular maintenance can help maximize service life.
                </p>
              </div>
            </div>
          </article>
